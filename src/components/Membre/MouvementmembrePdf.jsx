...
const styles = StyleSheet.create({
    ...
    tableColHeader: { width: "25%", borderStyle: "solid", borderColor: "#bfbfbf", borderBottomColor: "#000", borderWidth: 1, backgroundColor: "#f0f0f0" },
    tableCol: { width: "25%", borderStyle: "solid", borderColor: "#bfbfbf", borderBottomWidth: 1 },
...
function MouvementmembrePdf() {
    const carss = useSelector((state) => state.mouvementReducer);
    let n = 1;
                ...
                <Page size="A4" style={styles.page}>
                    ...
                    <View style={styles.Titre}>
                        <div className="text-center">
                            <Text style={{ fontSize: 10, fontWeight: "bold" }}>LISTE DES TOUT LES MOUVEMENTS</Text>
                        </div>
                    </View>
                                ...
                                {Array.isArray(carss) && carss.map((item) => (
                                    <>
                                        <View key={item.id} style={styles.tableRow}>
                                            ...
                                            <View style={styles.tableCol}>
                                                <Text style={styles.tableCell}>{item.membre && item.membre.nom}</Text>
                                            </View>
                                            <View style={styles.tableCol}>
                                                <Text style={styles.tableCell}>{item.mission && item.mission.mission}</Text>
                                            </View>
                                            <View style={styles.tableCol}>
...
export default MouvementmembrePdf