...
function RapportTypeDepensePdf(props) {
    const location = useLocation();
    const carss = location.state.rapportTypeDepensePdf;
    let n = 1;
                        ...
                        <div>
                            <View style={styles.table}>
                                <View style={styles.tableRow}>
                                    ...
                                    <View style={styles.tableColHeader}>
                                        <Text style={styles.tableCellHeader}>Caisse</Text>
                                    </View>
                                    <View style={styles.tableColHeader}>
                                        <Text style={styles.tableCellHeader}>Depense</Text>
                                    </View>
                                    <View style={styles.tableColHeader}>
                                ...
                                {Array.isArray(carss) && carss.map((item) => (
                                    <>
                                        <View key={item.id} style={styles.tableRow}>
                                            ...
                                            <View style={styles.tableCol}>
                                                <Text style={styles.tableCell}>{item.caisse && item.caisse.nom_caisse}</Text>
                                            </View>
                                            <View style={styles.tableCol}>
                                                <Text style={styles.tableCell}>{item.depense && item.depense.depense}</Text>
                                            </View>
                                            <View style={styles.tableCol}>
...
export default RapportTypeDepensePdf