...
function RapportMaterielPdf(props) {
    const location = useLocation();
    const carss = location.state.materielRapport;
    let n = 1;
                ...
                <Page size="A4" style={styles.page}>
                    ...
                    <View style={styles.Titre}>
                        <div className="text-center">
                            <Text style={{ fontSize: 10, fontWeight: "bold" }}>RAPPORT DES MATERIELS DU AU</Text>
                        </div>
                    </View>
...
export default RapportMaterielPdf