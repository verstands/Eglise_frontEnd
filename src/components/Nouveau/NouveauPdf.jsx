...
function NouveauPdf() {
    const carss = useSelector((state) => state.nouveauneReducer);
    let n = 1;
                ...
                <Page size="A4" style={styles.page}>
                    ...
                    <View style={styles.Titre}>
                        <div className="text-center">
                            <Text style={{ fontSize: 10, fontWeight: "bold" }}>LISTE DE NOUVEAU NE(E)</Text>
                        </div>
                    </View>
                        ...
                        <div>
                            <View style={styles.table}>
                                <View style={styles.tableRow}>
                                    ...
                                    <View style={styles.tableColHeader}>
                                        <Text style={styles.tableCellHeader}>Categarie</Text>
                                    </View>
                                </View>
