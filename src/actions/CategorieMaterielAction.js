...
export const ADD_CATEGORIE_MATERIEL = "ADD_CATEGORIE_MATERIEL";
...
export const addCategorie_materiel = (postData) => {
    return (dispatch) => {
        return axios.post(`${url}categorie_materiel`, postData,
            {
                headers: {
                    Accept: 'application/json',
                    'Content-Type': 'application/json',
                ...
                dispatch({ type: ADD_CATEGORIE_MATERIEL, payload: postData })
                Swal.fire({
                    icon: 'success',
                    text: `${response.data.message}`,
                    confirmButtonText: 'OK'
